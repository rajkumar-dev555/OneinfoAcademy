...
const Navbar = () => {
    ...
    const navItems = [
        ...
        { label: 'Testimonials', href: '/student-success-stories' },
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ">
                <div className="flex justify-between h-16 items-center">
                    ...
                    <Link href="/" className="flex-shrink-0 flex items-center cursor-pointer">
                        <Image src="/images/header-logo.png" alt="OneinfoAcademy Logo" width={160} height={48} className="h-12 w-auto object-contain" priority />
                    </Link>
