...
const WhyChooseUs = () => {
    ...
    const reasons = [
        {
            title: 'Elite MNC Mentors',
            description: 'Learn from active Engineering Leads in top-tier product MNCs. Our mentors don\'t just teach; they prepare you for global high-paying roles.',
            icon: (
