                ...
                <div ref={ref} className={`flex flex-col lg:flex-row items-center gap-12 lg:gap-20 ${animationClass}`}>
                    ...
                    <div className="lg:w-[55%] text-left space-y-8 animate-fade-in">
                        ...
                        <div className="flex flex-col sm:flex-row items-start gap-4">
                            <a
                                href="#programs"
                                className="w-full sm:w-auto px-10 py-5 bg-primary hover:bg-primary/90 text-white font-bold rounded-2xl transition-all shadow-xl shadow-primary/20 flex items-center justify-center gap-3 group active:scale-95"
                            >
                                Explore Programs
                            ...
                            <a
                                href="#contact"
                                className="w-full sm:w-auto px-10 py-5 bg-white dark:bg-gray-800 text-primary dark:text-white font-bold rounded-2xl transition-all border-2 border-primary/10 dark:border-white/10 hover:border-secondary flex items-center justify-center gap-2 active:scale-95"
                            >
                                Get Career Roadmap
                            </a>
                        </div>
                    ...
                    <div className="lg:w-[45%] relative animate-slide-up">
                        ...
                        <div className="absolute -left-10 bottom-24 z-20 bg-white dark:bg-gray-800 p-5 rounded-3xl shadow-2xl border border-gray-100 dark:border-gray-700 animate-bounce-slow max-w-[280px] transition-colors duration-300">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <div className="text-[10px] font-black text-primary dark:text-white uppercase tracking-[0.2em] mb-0.5">100% Guaranteed</div>
                                    <div className="text-sm font-bold text-gray-500 dark:text-gray-400 leading-tight">Placement Support with 100+ Hiring Partners</div>
                                </div>
                            </div>
                        </div>
