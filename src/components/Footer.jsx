                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
                    ...
                    <div>
                        ...
                        <ul className="space-y-3 text-gray-400 text-sm font-medium">
                            ...
                            <li><a href="#testimonials" className="hover:text-secondary transition-colors">Student Stories</a></li>
                            <li><a href="#placement" className="hover:text-secondary transition-colors">Career Support</a></li>
